---
description: Reviews code for quality and best practices using Google's Gemini model. Invoke
  in parallel with @review-openai when a code review is requested, to provide independent
